...
class UNET_SERESNEXT101(nn.Module):
    def __init__(self, num_classes, resolution, deepsupervision, clfhead, clf_threshold, load_weights=True):
        super().__init__()
        h,w = resolution
        ...
        #deep supervision
        self.deep4 = conv1x1(64,num_classes).apply(init_weight)
        self.deep3 = conv1x1(64,num_classes).apply(init_weight)
        self.deep2 = conv1x1(64,num_classes).apply(init_weight)
        self.deep1 = conv1x1(64,num_classes).apply(init_weight)
...
def build_model(model_name, num_classes, resolution, deepsupervision, clfhead, clf_threshold, load_weights):
    if model_name=='seresnext101':
        model = UNET_SERESNEXT101(num_classes, resolution, deepsupervision, clfhead, clf_threshold, load_weights)
    return model
